...
function best_responsive_preprocess_page(&$vars) {
  ...
  // http://js.api.here.com/se/2.5.4/jsl.js?with=maps,places,directions,positioning
}
...
function best_responsive_preprocess_html(&$vars) {
  ...
  drupal_add_js('http://js.api.here.com/se/2.5.4/jsl.js?with=maps,places,directions,positioning', 'external');
}
/**
 * logic house edit end
 */
